...
let PaymentsController = class PaymentsController {
    ...
    async create(locationId, body) {
        return this.paymentsService.create(locationId, body);
    }
    async updateStatus(locationId, id, body) {
...
__decorate([
    (0, common_1.Get)(),
    (0, require_privileges_decorator_1.RequirePrivileges)(['payments.read']),
...
__decorate([
    (0, common_1.Post)(),
    (0, require_privileges_decorator_1.RequirePrivileges)(['payments.write']),
    __param(0, (0, current_location_decorator_1.CurrentLocation)()),
