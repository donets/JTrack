...
- `ZodValidationPipe`: validates request payloads at controller boundary using shared schema contracts and normalizes JSON-stringified (including double-stringified) bodies before schema parse.
